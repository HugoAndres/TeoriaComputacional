...
if __name__ == "__main__":
    m = TuringMachine("11", [7])

    m.addTransition(0,'1',1,'1','R')
    m.addTransition(0,'0',1,'0','R')
    m.addTransition(1,'1',2,'1','L')
    m.addTransition(2,'1',3,'1','R')
    m.addTransition(3,'1',4,'1','R')
    m.addTransition(4,'_',5,'_','R')
    m.addTransition(5,'_',6,'1','R')
    m.addTransition(6,'_',7,'0','R')
    m.addTransition(2,'0',8,'0','R')
    m.addTransition(8,'1',9,'1','R')
    m.addTransition(9,'_',10,'_','R')
    m.addTransition(10,'_',7,'1','R')
    m.addTransition(1,'0',11,'0','L')
    m.addTransition(11,'1',12,'1','R')
    m.addTransition(12,'0',13,'0','R')
    m.addTransition(13,'_',14,'_','R')
    m.addTransition(14,'_',7,'1','R')
    m.addTransition(11,'0',15,'0','R')
    m.addTransition(15,'0',16,'0','R')
    m.addTransition(16,'_',17,'_','R')
    m.addTransition(17,'_',7,'0','R')
